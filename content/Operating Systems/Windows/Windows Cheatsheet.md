...
---
# Better output visiual 

| Command                                                      | Description                    |
| ------------------------------------------------------------ | ------------------------------ |
| `Sort-Object -Property`                                      | sort output based on property  |
| `Group-Object -property`                                     | group output based on property |
| `where DisplayName -like '*Defender*'` <br>or `Where-Object` | Filter based on condition.     |
| `ft property1, property2`<br>`format-table`                  | Display on table format        |
...
| - `-eq`, `-ieq`, `-ceq` - equals<br>- `-ne`, `-ine`, `-cne` - not equals<br>- `-gt`, `-igt`, `-cgt` - greater than<br>- `-ge`, `-ige`, `-cge` - greater than or equal<br>- `-lt`, `-ilt`, `-clt` - less than<br>- `-le`, `-ile`, `-cle` - less than or equal |                                                                                                                                                         |
...
| `Set-ItemProperty -Path "HKEY_CLASSES_ROOT\CLSID\{23170F69-40C1-278A-1000-000100020000}\InprocServer32" -Name "abc" -Value "C:\Users\public\reverse.dll"` | modify registry entry                                 |
